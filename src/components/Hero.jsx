...
export default function Hero() {
  return (
    <section id="inicio" className="ink-panel relative min-h-screen overflow-hidden pt-28 text-cream-50">
      ...
      <div className="absolute -right-24 top-24 h-[28rem] w-[28rem] rounded-full bg-moss-500/15 blur-3xl" />
      <div className="absolute -left-20 bottom-10 h-72 w-72 rounded-full bg-signal/10 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-16">
        ...
        >
          <a
            href="#proyectos"
            className="border border-cream-50 bg-cream-50 px-8 py-3.5 text-xs font-medium uppercase tracking-wider text-ink-950 transition hover:bg-cream-100"
          >
            Ver proyectos
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 border border-cream-200/30 px-8 py-3.5 text-xs uppercase tracking-wider text-cream-50 transition hover:border-moss-400 hover:text-moss-400"
          >
            <GitHubIcon size={16} />
            GitHub
          </a>
          <a
            ...
            className="inline-flex items-center gap-2 border border-cream-200/30 px-8 py-3.5 text-xs uppercase tracking-wider text-cream-50 transition hover:border-signal hover:text-signal"
          >
            <Mail size={16} />
            Contacto
          </a>
