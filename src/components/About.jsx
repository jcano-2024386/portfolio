  ...
  return (
    <section id="sobre-mi" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
      <div className="grid gap-12 md:grid-cols-2 md:gap-20">
        ...
        <Reveal variant="right" delay={100} className="space-y-6">
          <div>
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            {profile.tools.map((tool) => (
              <span
                key={tool}
                className="border border-ink-200 bg-cream-100 px-3 py-1.5 text-xs text-ink-800 transition duration-300 hover:-translate-y-0.5 hover:border-moss-400"
              >
                {tool}
              </span>
            ))}
